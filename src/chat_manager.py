...
class ChatManager:
    def __init__(self, prompt_manager: PromptManager, openai_llm_model_name: str = "gpt-4o-mini"):
        """
        Initializes the ChatManager with a specified OpenAI language model and sets up
        the chat prompt, session ID, and chat history storage.

        Args:
            prompt_manager (PromptManager): Instance responsible for managing prompts,
                used to create the chat prompt template.
            openai_llm_model_name (str): The name of the OpenAI language model to use for the chat.
    ...
    def conversation_ended(self, user_input: str) -> bool:
        """
